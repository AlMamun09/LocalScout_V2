namespace LocalScout.Application.DTOs.PaymentDTOs
{
    ...
    public class SSLCommerzSettings
    {
        ...
        public string SandboxUrl { get; set; } = "https://sandbox.sslcommerz.com/gwprocess/v4/api.php";
        public string LiveUrl { get; set; } = "https://securepay.sslcommerz.com/gwprocess/v4/api.php";
