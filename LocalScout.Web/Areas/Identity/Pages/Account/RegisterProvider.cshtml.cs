...
namespace LocalScout.Web.Areas.Identity.Pages.Account
{
    public class RegisterProviderModel : PageModel
    {
        ...
        private readonly ILogger<RegisterProviderModel> _logger;
        ...
        public RegisterProviderModel(
            ...
            ILogger<RegisterProviderModel> logger,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    _logger.LogInformation("Provider created a new account with password.");

                    // Assign Provider role instead of User role
                    ...
                    if (_userManager.Options.SignIn.RequireConfirmedAccount)
                    {
                        return RedirectToPage(
                            ...
                            new { email = Input.Email, returnUrl = returnUrl, userType = "provider" }
                        );
                    }
                    else
                    {
